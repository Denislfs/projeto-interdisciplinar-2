          ...
          <div class="px-4 py-5 bg-white sm:p-6">
            <div class="grid grid-cols-6 gap-6">
              ...
              <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                ...
                <input type="text" name="cpf" id="cpf" autocomplete="" onkeypress="$(this).mask('000.000.000-00')" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" maxlength=11>
              </div>
